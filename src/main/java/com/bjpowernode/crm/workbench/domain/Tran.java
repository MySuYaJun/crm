...
public class Tran {
    ...
    /*
        为了在明细页面显示可能性，而添加的自定义属性：possibility
     */
    private String possibility;

    /**
    * 为了显示交易阶段图标而添加的自定义属性：表示当前交易所处阶段的orderNo
    */
    ...
    /**
     * Gets the value of possibility
     *
     * @return the value of possibility
     */
     ...
     * <p>You can use getPossibility() to get the value of possibility</p>
     *
